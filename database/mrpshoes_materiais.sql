...
--
-- Host: localhost    Database: mrpshoes
-- ------------------------------------------------------
...
CREATE TABLE `materiais` (
  ...
  `quantidade_material` int DEFAULT NULL,
  `quantidade_necessaria` int NOT NULL,
  `produto_id` int DEFAULT NULL,
  PRIMARY KEY (`material_id`),
  KEY `produto_id_idx` (`produto_id`),
  CONSTRAINT `produto_id` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`produto_id`)
...
-- Dump completed on 2023-11-06  0:22:54
